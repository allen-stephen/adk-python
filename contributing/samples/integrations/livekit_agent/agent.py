...
"""A live voice agent that rolls dice and checks primes.

This is a plain ADK live agent -- it has no knowledge of LiveKit. `adk web`
runs it locally in the browser, and `livekit_worker.py` puts the SAME
`root_agent` behind a real transport (telephony / WebRTC / Unity) with no
